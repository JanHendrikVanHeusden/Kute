...
3. #### Add extra values, e.g. argument values
    In the example below, we want not only the class's properties to be included in the logging,<br> but also the function argument `relatedInvoices`:
    ```
