...
import nl.kute.core.isCharSequenceType
import nl.kute.core.isCollectionType
...
public interface PropertyValueMetaData {
    ...
    /** Is the property's return type considered a base type, according to [nl.kute.core.isBaseType]? */
