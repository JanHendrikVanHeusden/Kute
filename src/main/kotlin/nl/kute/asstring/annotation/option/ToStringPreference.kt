 ...
 * * See the KDoc for [USE_ASSTRING] / [PREFER_TOSTRING] for characteristics of each.
 *
...
public enum class ToStringPreference {
     ...
     * If no overridden [toString] is present, the properties will be resolved dynamically (like with [USE_ASSTRING]).
     *
     * Characteristics:
