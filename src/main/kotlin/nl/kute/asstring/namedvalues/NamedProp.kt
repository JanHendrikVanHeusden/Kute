 ...
 * ```
 * * Usage of [NamedProp] in a pre-built [nl.kute.asstring.core.AsStringBuilder] is good practice,
 *   as reassignment is reflected
 * * All annotations that affect output of [nl.kute.asstring.core.asString] are taken in account:
...
public final class NamedProp<T : Any?, V : Any?>(public override val property: KProperty<V>, obj: T?) :
    ...
    final override val value: String?
        ...
        else objectReference.get()?.getPropValueString(property, asStringAffectingAnnotations)?.second
